...
import { cancelServiceRequest } from "@/lib/service-service";
import { cancelServiceSchema } from "@/lib/service-validations";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    const updated = await cancelServiceRequest(prisma, {
